    ...
    <div className="relative h-screen flex justify-center items-center">
      ...
      <div className="absolute">
        ...
        {connecting ? (
          ...
          <a
            href={`${AUTH_ENDPOINT}?client_id=${CLIENT_ID}&response_type=${RESPONSE_TYPE}&redirect_uri=${redirect_uri}&scope=user-read-private%20user-top-read%20playlist-read-private%20playlist-read-collaborative%20user-read-recently-played`}
          >
